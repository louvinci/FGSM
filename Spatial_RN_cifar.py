# This is spatial conv-based ResNet model in the CIFAR10 dataset
__all__ = ['RN18_cifar10','RN34_cifar10','RN50_cifar10','RN101_cifar10','RN152_cifar10']
...
def linear(in_featrues, out_features):
    return Fc(in_featrues, out_features)
